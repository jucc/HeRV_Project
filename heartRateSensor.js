...
/*
    ...
    parseHeartRate(value) {
      ...
      if (rate16Bits) {
        ...
        //result.heartRate = value.getUint16(index,littleEndian=true); - it was as an alternative
        index += 2;
      } else {
      ...
      if (energyPresent) {
        ...
        //result.energyExpended = value.getUint16(index, littleEndian=true); - it was as an alternative
        index += 2;
      }
